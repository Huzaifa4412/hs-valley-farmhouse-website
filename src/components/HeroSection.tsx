...
export function HeroSection({ onOpenInquiry }: HeroSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div
        data-parallax="0.14"
        className="absolute -top-[9%] left-0 right-0 h-[118%] overflow-hidden"
      >
        <picture className="hero-image-in block w-full h-full">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        <div className="max-w-4xl">
          {/* Eyebrow Label */}
          <div className="hero-rise hero-rise-1 flex items-center gap-2.5 sm:gap-3 mb-3 sm:mb-4">
          ...
          <h1
            className="hero-rise hero-rise-2 hero-title font-serif-editorial text-[#FAF9F5] font-light leading-[1.08] sm:leading-[1.05] tracking-tight uppercase mb-4 sm:mb-6"
          >
          ...
          <p
            className="hero-rise hero-rise-3 text-sm sm:text-base md:text-lg font-sans-body text-[#FAF9F5]/85 font-light leading-relaxed max-w-2xl mb-6 sm:mb-8"
          >
          ...
          <div
            className="hero-rise hero-rise-4 flex flex-wrap items-center gap-x-4 gap-y-2 mb-6 sm:mb-8 text-[10px] sm:text-[11px] font-mono uppercase tracking-[0.18em] text-[#FAF9F5]/70">
          ...
          {/* CTAs */}
          <div
            className="hero-rise hero-rise-5 flex flex-col xs:flex-row items-stretch xs:items-center gap-3 sm:gap-6"
          >
            <a
              href="#intro-statement"
              onClick={handleExploreClick}
              data-cursor="explore"
              className="group btn-sheen px-6 sm:px-7 py-3.5 min-h-[44px] rounded-full bg-[#FAF9F5] hover:bg-[#B99A5B] text-[#0B0F0D] text-xs uppercase tracking-[0.2em] font-semibold transition-all duration-300 shadow-lg flex items-center justify-center gap-2"
            >
              <span>EXPLORE</span>
            ...
            <button
              ...
              data-cursor="explore"
              className="group btn-sheen px-6 sm:px-7 py-3.5 min-h-[44px] rounded-full border border-[#B99A5B]/60 hover:border-[#B99A5B] bg-[#14251D]/80 hover:bg-[#14251D] text-[#FAF9F5] text-xs uppercase tracking-[0.2em] font-medium transition-all duration-300 backdrop-blur-sm flex items-center justify-center gap-2 cursor-pointer"
            >
              <span>BOOK NOW</span>
      ...
      <a
        ...
        onClick={handleExploreClick}
        data-cursor="explore"
        className="hero-rise hero-rise-6 hidden md:flex absolute bottom-8 right-8 md:right-12 z-10 flex-col items-center gap-2 group text-[#FAF9F5]/60 hover:text-[#B99A5B] transition-colors"
